...
app.get("/game.min.js", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_j) {
        switch (_j.label) {
            case 0:
                _b = (_a = JSON).parse;
                return [4 /*yield*/, node_fetch_1.default('https://play.prodigygame.com/play')];
            case 1: return [4 /*yield*/, (_j.sent()).text()];
            case 2:
            ...
            case 5: return [4 /*yield*/, (_j.sent()).text()];
            case 6:
                gameMinJS = _j.sent();
                res.type(".js");
                replacements = [
            ...
            case 7: return [4 /*yield*/, (_j.sent()).text()];
            case 8: return [2 /*return*/, _d.apply(_c, [_f.apply(_e, _g.concat([_h + (_j.sent()) + "\n\t\t\t}, 15000);\n\t\t"]))])];
        }
    });
}); });
